static void removeMotorSignal(caerModuleData moduleData);
static void applyMotorSignal(caerModuleData moduleData);

void removeMotorSignal(caerModuleData moduleData) {
...
void applyMotorSignal(caerModuleData moduleData) {
