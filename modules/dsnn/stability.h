...
static void applyLearningPathwaySignal(caerModuleData moduleData);
static void removeLearningPathwaySignal(caerModuleData moduleData);
...
void applyLearningPathwaySignal(caerModuleData moduleData) {
	if (not_ready_added == 1) {
		int64_t pre_row_id, post_row_id, post_col_id, post_neuron_id;
		uint32_t pre_neuron_addr, post_neuron_addr;
		int32_t cam_id, synapse_type;
...
void removeLearningPathwaySignal(caerModuleData moduleData) {
	if (not_ready_added == 0) {
		int64_t pre_row_id, post_row_id, post_col_id, post_neuron_id;
		uint32_t pre_neuron_addr, post_neuron_addr;
		int32_t cam_id, synapse_type;
