# Install script for directory: /home/dongchen/dynapse/caer/modules/misc/in
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/share/caer/caer_input_file.so")
...
file(INSTALL DESTINATION "/usr/local/share/caer" TYPE SHARED_LIBRARY FILES "/home/dongchen/dynapse/caer/modules/misc/in/caer_input_file.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/share/caer/caer_input_file.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/share/caer/caer_input_file.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/share/caer/caer_input_file.so"
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/share/caer/caer_input_net_tcp_client.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/usr/local/share/caer" TYPE SHARED_LIBRARY FILES "/home/dongchen/dynapse/caer/modules/misc/in/caer_input_net_tcp_client.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/share/caer/caer_input_net_tcp_client.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/share/caer/caer_input_net_tcp_client.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/share/caer/caer_input_net_tcp_client.so"
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/share/caer/caer_input_net_socket_client.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/usr/local/share/caer" TYPE SHARED_LIBRARY FILES "/home/dongchen/dynapse/caer/modules/misc/in/caer_input_net_socket_client.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/share/caer/caer_input_net_socket_client.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/share/caer/caer_input_net_socket_client.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/share/caer/caer_input_net_socket_client.so"
